...
import mos.mosback.dto.PostSaveRequestDto;
import mos.mosback.dto.PostsListResponseDto;
import mos.mosback.dto.PostsResponseDto;
import mos.mosback.dto.PostsUpdateRequestDto;
...
public class PostsController {
    ...
    private final PostService postService; // PostService를 주입받습니다.
...
//deletePost: 게시물을 삭제하는 엔드포인트입니다.
//getAllPosts: 모든 게시물을 조회하는 엔드포인트.
//getPopularPosts:조회순으로 게시물을 조회하는 엔드포인트.